...
{
    [DbContext(typeof(AdvBoxCRMDbContext))]
    partial class AdvBoxCRMDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AdvBoxCRM.Boxes.Box", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");

                    b.Property<string>("BoxAdress")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<bool>("BoxCorrosion")
                        .HasColumnType("boolean");

                    b.Property<bool>("BoxFullness")
                        .HasColumnType("boolean");
                    ...
                    b.ToTable("AppBoxes", (string)null);
                });

            modelBuilder.Entity("AdvBoxCRM.Employees.Employee", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("AdvBoxCRM.Guests.Guest", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppGuest", (string)null);
                });

            modelBuilder.Entity("AdvBoxCRM.Maintanances.Maintanance", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppMaintanances", (string)null);
                });
            ...
            modelBuilder.Entity("AdvBoxCRM.Maintanances.Maintanance", b =>
                {
                    b.HasOne("AdvBoxCRM.Boxes.Box", null)
                        .WithMany()
                        .HasForeignKey("BoxID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AdvBoxCRM.Employees.Employee", null)
                        .WithMany()
